      ...
      <div className="card-inner">
        <div className="card-wrap">
                ...
                <div className="text-box"  data-aos="fade-up">
                  <p>
                    <b>I'm</b>{" "} {new Date().getFullYear() <=2024 ? ` a ${new Date().getFullYear() - 2020}${new Date().getFullYear() < 4 ? "th" : "rd" } year B.tech student pursuing ` : "graduated "}
                     Computer Engineering from Institute of Engineering (TU), Dharan. I love solving problems, thinking critically, and finding innovative solutions. My short-term goal is to become a proficient software developer, and my long-term goal is to work as a data scientist and become an AI engineer.
                  </p>
                </div>
              </div>
              <div className="col col-6 border-line-v">
                <div className="info-list"  data-aos="fade-up">
                  <ul>
                    ...
                    <li>
                      <strong>Gmail: </strong>srijanpokhrel1@gmail.com
                    </li>
                    <li>
                      <strong>Residence: </strong>Kathmandu, Nepal
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div className="content services">
            <div className="title">
              <span className="first-word">My{" "}</span>Profession
            </div>
