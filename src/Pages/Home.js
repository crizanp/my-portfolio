        ...
        <div className="profile">
          ...
          <div className="subtitle subtitle-typed">
            <TypeWriterEffect
              ...
              startDelay={2000}
              cursorColor="#1523f3ff"
              multiText={[ "Computer Engineer", "Software Developer", "Data Scientist","Blockchain Developer"]}
              multiTextDelay={1000}
              typeSpeed={50}
              multiTextLoop
            />
          ...
          <div className="social">
            <a
              className="link"
              href="https://www.facebook.com/srijanpokhrel11"
              rel="noreferrer"
              target="_blank"
              aria-label="facebook"
            ...
            <a
              className="link"
              href="https://twitter.com/srijan_pokhrel"
              rel="noreferrer"
              target="_blank"
              aria-label="twitter"
  ...
  .card-section {
    ...
    .profile {
      ...
      .slide {
        ...
        width: 100%;
        height: 52%;
      /* dark overlay layered on top of the background image so the
        profile picture remains clearly visible */
      background: linear-gradient(rgba(0,0,0,0.55), rgba(0,0,0,0.55)), url("/assets/portfolio.png");
